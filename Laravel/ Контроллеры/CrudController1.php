...
class CrudController extends Controller {
    ...
    public function query($model, Request $request) {
     ...
     */
    public function first($model, $id, Request $request) {
     ...
     *
     */
    public function execute($model, $function, $id = null, Request $request) {
        $object = $this -> _getModel($model);
